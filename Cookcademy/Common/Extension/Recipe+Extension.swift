...
//  Cookcademy
//
//  Created by Hannah Williams on 15/01/2024.
//
...
extension Recipe {
  static let testRecipes: [Recipe] = [
    Recipe(mainInformation: MainInfo(name: "Dad's Mashed Potatoes",
    ...
    Recipe(mainInformation: MainInfo(name: "Beet and Apple Salad",
    ...
    Recipe(mainInformation: MainInfo(name: "Braised Beef Brisket",
    ...
    Recipe(mainInformation: MainInfo(name: "Best Brownies Ever",
    ...
    Recipe(mainInformation: MainInfo(name: "Omelet and Greens",
    ...
    Recipe(mainInformation: MainInfo(name: "Vegetarian Chili",
    ...
    Recipe(mainInformation: MainInfo(name: "Classic Shrimp Scampi",
    ...
    Recipe(mainInformation: MainInfo(name: "Chocolate Billionaires",
    ...
    Recipe(mainInformation: MainInfo(name: "Mac & Cheese",
    ...
    Recipe(mainInformation: MainInfo(name: "Veggie Soup",
    ...
    Recipe(mainInformation: MainInfo(name: "White Clam Sauce",
    ...
    Recipe(mainInformation: MainInfo(name: "Granola Bowl",
    ...
    Recipe(mainInformation: MainInfo(name: "Banana Bread",
